         ...
         annotation:(id)annotation
{
    ...
    if (annotation) {
        userInfo = @{PGSKApplicationLaunchOptionspAplicationKey:application,
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:PGSKApplicationLaunchNotification
                                                        object:self
                                                      userInfo:userInfo];
    return YES;
}
